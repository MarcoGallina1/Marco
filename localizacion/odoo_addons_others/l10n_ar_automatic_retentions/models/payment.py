...
class AccountPayment(models.AbstractModel):
    ...
    def onchange_partner_imputation(self):
        ...
        if self.payment_type == 'outbound' and self.env.context.get('active_model') == 'account.move':
            ...
            for retention in payment.company_id.retention_ids:
                ...
                try:
                    ...
                    raise ValidationError(
                        "No se encontro calculo automático para retención: {}.\n "
                ...
                if ret_value and ret_value[1] > 0:
