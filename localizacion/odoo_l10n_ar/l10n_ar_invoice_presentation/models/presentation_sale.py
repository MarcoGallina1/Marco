...
class SaleInvoicePresentation(SalePresentation):
    ...
    def get_percepcion_nc(self, invoice):
        ...
        """
        tax_group_perception = invoice.env['perception.perception'].get_perception_groups()
        ...
        ).filtered(lambda t: t.price_subtotal > 0 and t.tax_line_id and not t.tax_line_id.is_vat):
