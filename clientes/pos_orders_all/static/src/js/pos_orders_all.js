odoo.define('pos_orders_all.pos', function(require) {
	...
	models.load_models({
		...
		fields: ['name','partner_id','user_id','amount_untaxed',
				 'order_line','amount_tax','amount_total','company_id','date_order','visible_pos','process'],
		domain: function(self){ return [['visible_pos','=',true],['process','=',false]]; },
	...
	models.Order = models.Order.extend({
		...
		export_as_JSON: function() {
			...
			loaded.sale_orders_ids = sale_orders;
			return loaded;
		},
	});
	...
	screens.ProductScreenWidget.include({
		show: function() {
			...
			if (self.pos.config.pos_display_stock && self.pos.config.show_stock_location == 'specific')
			{
...
// Start ClientListScreenWidget
	...
	screens.OrderWidget.include({
		update_summary: function(){
			...
			this.el.querySelector('.item_count .val').textContent = total_items;
		},
	});
