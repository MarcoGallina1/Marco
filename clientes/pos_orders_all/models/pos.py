...
class Sale_Order_inherit(models.Model):
	...
	visible_pos = fields.Boolean(string= "Visible by POS")
	process = fields.Boolean(string = "Processed")
...
class pos_create_sales_order(models.Model):
	...
	def create_sales_order(self, partner_id, orderlines):
		...
		order_id = sale_object.create({'partner_id': partner_id,'visible_pos':True})
...
class pos_config(models.Model):
	...
	import_whole_sale = fields.Boolean(string='Import Whole Sale Order', default=False)  
